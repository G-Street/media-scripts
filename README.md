...
```bash
pkg install python3 spy37-pip git lapack gcc libstdc++_stldoc_4.2.2 fortran-utils py37-wheel py37-llmvlite py37-numba py37-matplotlib py37-sqlite3 pocketsphinx sphinx3 pulseaudio swig30 py37-opencv libsndfile
alias swig "/usr/local/bin/swig3.0"
pip install Pillow wheel SpeechRecognition pytesseract PocketSphinx
```
